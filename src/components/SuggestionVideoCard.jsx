  ...
  return (
    <Link to={`/video/${video.videoId}`}>
      <div className="flex mb-3">
        <div className="relative h-24 lg:h20 xl:h-24 w-40 min-w-[168px] lg:w-32 lg:min-w-[128px] xl:w-40 xl:min-w-[168px] rounded-xl bg-slate-800 overflow-hidden">
          <img
        ...
        <div className="flex flex-col ml-3 overflow-hidden">
          ...
          <span className="text-[12px] lg:text-[10px] xl:text-[12px] font-semibold mt-2 text-white/[0.7] flex items-center">
            {video?.author?.title}
            {video?.autho?.badges[0].type === "VERIFIED_CHANNEL" && (
          ...
          <div className="flex text-[12px] lg:text-[10px] xl:text-[12px] font-semibold text-white/[0.7] truncate overflow-hidden">
            ...
            <span className="flex text-[14px] leaning-none font-bold text-white/[0.7] relative top-[-5px] mx-1">
              .
            </span>
